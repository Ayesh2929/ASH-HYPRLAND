...
check_config_files() {
    ...
    chk "env.conf"              "test -f '${CONFIG_DIR}/hypr/env.conf'"
    chk "keybinds.conf"         "test -f '${CONFIG_DIR}/hypr/keybinds/default.conf'"
    chk "autostart.conf"        "test -f '${CONFIG_DIR}/hypr/autostart.conf'"
    chk "windowrules.conf"      "test -f '${CONFIG_DIR}/hypr/windowrules.conf'"
    chk "ash theme engine"      "command -v ash && ash theme list"
    chk "waybar config.jsonc"   "test -f '${CONFIG_DIR}/waybar/config.jsonc'"
    chk "waybar style.css"      "test -f '${CONFIG_DIR}/waybar/style.css'"
...
check_theme() {
    ...
    chk "Waybar colors"     "test -f '${CONFIG_DIR}/waybar/colors.css'" "optional"
