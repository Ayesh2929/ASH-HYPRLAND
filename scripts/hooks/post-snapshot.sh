#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/post-snapshot.sh
# ║  Post snapshot
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run after a config snapshot was taken
# ash:timeout=15
#
...
main() {
    ...
    notify "Post snapshot" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
