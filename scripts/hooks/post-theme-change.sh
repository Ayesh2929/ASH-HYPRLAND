#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/post-theme-change.sh
# ║  Post theme change
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run after a theme was applied
# ash:timeout=10
#
...
main() {
    ...
    notify "Post theme change" "${ASH_HOOK_ARGS:-}" normal
