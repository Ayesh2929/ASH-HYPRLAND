#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-network-disconnect.sh
# ║  Network disconnected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when the network connection drops
# ash:timeout=10
#
...
usage() {
    cat <<EOF
${SCRIPT_NAME} — Network disconnected
...
main() {
    ...
    notify "Network disconnected" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
