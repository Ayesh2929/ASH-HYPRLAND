#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-network-connect.sh
# ║  Network connected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when a network connection is established
# ash:timeout=10
#
...
main() {
    ...
    notify "Network connected" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
