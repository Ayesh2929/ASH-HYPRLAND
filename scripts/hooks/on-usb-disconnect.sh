#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-usb-disconnect.sh
# ║  USB disconnected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when a USB device is removed
# ash:timeout=10
#
...
main() {
    ...
    notify "USB disconnected" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
