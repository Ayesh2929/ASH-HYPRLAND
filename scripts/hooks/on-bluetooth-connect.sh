#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-bluetooth-connect.sh
# ║  Bluetooth connected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when a Bluetooth device connects
# ash:timeout=10
#
...
usage() {
    cat <<EOF
${SCRIPT_NAME} — Bluetooth connected
...
main() {
    ...
    notify "Bluetooth connected" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
