#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-battery-critical.sh
# ║  Battery critical
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run once the battery is critically low
# ash:timeout=10
#
...
main() {
    ...
    notify "Battery critical" "${ASH_HOOK_ARGS:-}" critical
    log_event "done"
    exit 0
}
