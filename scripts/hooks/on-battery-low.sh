#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-battery-low.sh
# ║  Battery low
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run once the battery drops below the low threshold
# ash:timeout=10
#
...
main() {
    ...
    notify "Battery low" "${ASH_HOOK_ARGS:-}" normal
    log_event "done"
    exit 0
}
