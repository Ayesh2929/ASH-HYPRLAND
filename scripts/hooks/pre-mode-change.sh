#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/pre-mode-change.sh
# ║  Pre mode change
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run before the desktop switches mode
# ash:timeout=10
#
...
main() {
    ...
    notify "Pre mode change" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
