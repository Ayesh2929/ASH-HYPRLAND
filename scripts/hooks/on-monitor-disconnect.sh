#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-monitor-disconnect.sh
# ║  Monitor disconnected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when a display is unplugged
# ash:timeout=10
#
...
usage() {
    cat <<EOF
${SCRIPT_NAME} — Monitor disconnected
...
main() {
    ...
    notify "Monitor disconnected" "${ASH_HOOK_ARGS:-}" low
