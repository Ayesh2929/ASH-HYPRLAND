#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/post-mode-change.sh
# ║  Post mode change
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run after the desktop switched mode
# ash:timeout=10
#
...
main() {
    ...
    notify "Post mode change" "${ASH_HOOK_ARGS:-}" normal
