#!/usr/bin/env bash
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║  ⚡ ASH DOTFILES v5.0 OMEGA — scripts/hooks/on-bluetooth-disconnect.sh
# ║  Bluetooth disconnected
# ╚═══════════════════════════════════════════════════════════════════════════════╝
#
# ash:description=Run when a Bluetooth device disconnects
# ash:timeout=10
#
...
usage() {
    cat <<EOF
${SCRIPT_NAME} — Bluetooth disconnected
...
main() {
    ...
    notify "Bluetooth disconnected" "${ASH_HOOK_ARGS:-}" low
    log_event "done"
    exit 0
}
